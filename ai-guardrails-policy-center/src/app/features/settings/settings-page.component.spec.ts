...
describe('SettingsPageComponent', () => {
  ...
  it('renders workspace settings', () => {
    ...
    expect(nativeElement.textContent).toContain('Log blocked prompts');
  });

  it('saves after a toggle', () => {
    internals(component).toggle('logBlocked', false);
    expect(internals(component).logBlocked()).toBe(false);
