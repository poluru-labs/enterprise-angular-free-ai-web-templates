    ...
    <section class="split" style="margin-top: 0.9rem">
      <eds-card class="card-pad" [elevated]="false">
        <div class="section-head">
          ...
          <eds-tag label="8 accounts" variant="brand"></eds-tag>
        </div>
      ...
      <eds-card class="card-pad" [elevated]="false">
        ...
        <p class="meta">Scored on Ananya Poluru’s enterprise seller set.</p>
...
export class OverviewPageComponent {
  ...
  protected readonly accountRows = this.config.accounts.slice(0, 5).map((entry) => ({
    name: entry.name,
    owner: entry.owner,
